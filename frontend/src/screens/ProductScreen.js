      ...
      {loading ? (
        ...
        <div className="container-fluid m-0 p-0">
          ...
          <div className="container-fluid row">
            ...
            >
              <ReactPlayer url="https://www.youtube.com/watch?v=Yt8kRCfbD7s" />
            </Col>
            <Col md={3}>
          ...
          <div className="container-fluid row m-0 mt-5 p-4 acd">
            ...
            <Col md={6}>
              ...
              <p style={{ color: 'white' }}>
                This course contains 128 interactive screencasts spread across 9
                modules.
              </p>
              <div className="col-12 my-2">
                ...
                >
                  1. Introduction{' '}
                  <img className="triangle-product-screen" src={traingle} />
                </Button>
                <Collapse in={open1}>
